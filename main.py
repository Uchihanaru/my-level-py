...
def run_http():
    # Render assigns a port in the environment variable PORT. Default to 8080 if not found.
    port_to_listen = int(os.environ.get("PORT", 8080))
    app.run(host='0.0.0.0', port=port_to_listen)
